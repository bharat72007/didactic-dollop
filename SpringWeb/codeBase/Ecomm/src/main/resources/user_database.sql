...
CREATE TABLE IF NOT EXISTS TEST_ECOM.T_USERS(
	...
	PRIMARY KEY (`ID`),
	CONSTRAINT FOREIGN KEY (`REGISTRATION_ID`) REFERENCES `T_REGISTRATION` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8;  

CREATE TABLE IF NOT EXISTS TEST_ECOM.T_T_USERS_Token(
	ID INT(5) NOT NULL AUTO_INCREMENT,
	AuthToken BINARY(16) NOT NULL,
	Token_Expiry DATETIME,
	USER_ID INT(5) NOT NULL,
	PRIMARY KEY (`ID`),
	CONSTRAINT FOREIGN KEY (`USER_ID`) REFERENCES `T_USERS` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS TEST_ECOM.T_PRODUCT_SUBCATEGORY(
	...
	LAST_UPTO_DATE DATETIME,
	PRIMARY KEY (`ID`),
	CONSTRAINT FOREIGN KEY (`CATEGORY_ID`) REFERENCES T_PRODUCT_CATEGORY(`ID`) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8;  
...
CREATE TABLE IF NOT EXISTS TEST_ECOM.T_PRODUCT(
	...
	PRIMARY KEY (`ID`),
	CONSTRAINT FOREIGN KEY (`CATEGORY_ID`) REFERENCES T_PRODUCT_CATEGORY(`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FOREIGN KEY (`SUBCATEGORY_ID`) REFERENCES T_PRODUCT_SUBCATEGORY(`ID`) ON DELETE CASCADE ON UPDATE CASCADE										
)ENGINE=InnoDB DEFAULT CHARSET=utf8;  
...
CREATE TABLE IF NOT EXISTS TEST_ECOM.T_COUPONS(
	...
	LAST_UPTO_DATE DATETIME,
	PRIMARY KEY (`ID`),
	CONSTRAINT FOREIGN KEY (`PRODUCT_ID`) REFERENCES T_PRODUCT(`ID`) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8;  
...
--	FOREIGN KEY (`ADDRESS_TYPE`) REFERENCES T_USER_ADDRESS_TYPE(`ADDRESS_TYPE`) ON DELETE CASCADE,
	CONSTRAINT FOREIGN KEY (`PIN`) REFERENCES T_PIN(`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
	PRIMARY KEY (`ID`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;  
...
CREATE TABLE IF NOT EXISTS TEST_ECOM.T_USER_ORDER(
	...
	CONSTRAINT FOREIGN KEY (`ORDER_STATUS`) REFERENCES T_ORDER_STATUS(`ORDER_STATUS`) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FOREIGN KEY (`SHIPMENT_STATUS`) REFERENCES T_SHIPMENT_STATUS(`SHIPMENT_STATUS`) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FOREIGN KEY (`PAYMENT_STATUS`) REFERENCES T_PAYMENT_STATUS(`PAYMENT_STATUS`) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FOREIGN KEY (`SHIPPING_ADDRESS_ID`) REFERENCES T_USER_ADDRESS(`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FOREIGN KEY (`BILLING_ADDRESS_ID`) REFERENCES T_USER_ADDRESS(`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FOREIGN KEY (`INVOICE_ID`) REFERENCES T_INVOICE(`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
	PRIMARY KEY (`ID`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;  
